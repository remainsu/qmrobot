...
class Contact extends accessory_1.Accessory {
    ...
    static tags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const tagIdList = yield this.puppet.tagContactList();
    ...
    say(something) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof something === 'string') {
                 ...
                 * 1. Text
                 */
                msgId = yield this.puppet.messageSendText(this.id, something);
            }
    ...
    tags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const tagIdList = yield this.puppet.tagContactList(this.id);
                const tagList = tagIdList.map(id => this.wechaty.Tag.load(id));
                return tagList;
            }
            catch (e) {
    ...
    ready(forceSync = false) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.log.silly('Contact', 'ready() @ %s with id="%s"', this.puppet, this.id);
            ...
            try {
                ...
                config_1.log.verbose('Contact', 'ready() this.puppet.contactPayload(%s) exception: %s', this.id, e.message);
                config_1.Raven.captureException(e);
                throw e;
            }
        });
