...
class IoClient {
    constructor(options) {
        ...
        config_1.log.verbose('IoClient', 'constructor({token: %s})', options.token);
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.startIo();
                yield this.options.wechaty.start();
                yield this.startHostie();
                this.state.on(true);
            }
            catch (e) {
