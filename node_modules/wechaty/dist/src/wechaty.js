...
class Wechaty extends events_1.EventEmitter {
    ...
    constructor(options = {}) {
        ...
        this.Image = clone_class_1.cloneClass(user_1.Image);
        ...
        this.Tag = clone_class_1.cloneClass(user_1.Tag);
    ...
    addListenerModuleFile(event, modulePath) {
        ...
        config_1.log.verbose('Wechaty', 'addListenerModuleFile() hotImport(%s)', absoluteFilename);
        hot_import_1.hotImport(absoluteFilename)
            ...
            try {
                ...
                config_1.log.error('Wechaty', 'addListenerModuleFile(%s, %s) listener exception: %s', event, modulePath, e);
                this.emit('error', e);
            }
        }))
            .catch(e => {
            config_1.log.error('Wechaty', 'addListenerModuleFile(%s, %s) hotImport() exception: %s', event, modulePath, e);
            this.emit('error', e);
        });
        if (config_1.isProduction()) {
            config_1.log.verbose('Wechaty', 'addListenerModuleFile() disable watch for hotImport because NODE_ENV is production.');
    ...
    addListenerFunction(event, listener) {
        config_1.log.verbose('Wechaty', 'addListenerFunction(%s)', event);
        /**
        ...
        super.on(event, (...args) => {
            try {
                ...
                config_1.log.error('Wechaty', 'addListenerFunction(%s) listener exception: %s', event, e);
                this.emit('error', e);
            }
        });
    }
        ...
        for (const eventName of eventNameList) {
            ...
            switch (eventName) {
                ...
                case 'heartbeat':
                    ...
                    break;
                case 'friendship':
                    puppet.on('friendship', (payload) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    break;
                case 'login':
                    puppet.on('login', (payload) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    break;
                case 'logout':
                    puppet.on('logout', (payload) => __awaiter(this, void 0, void 0, function* () {
                        const contact = this.ContactSelf.load(payload.contactId);
                        yield contact.ready();
                    ...
                    break;
                case 'message':
                    puppet.on('message', (payload) => __awaiter(this, void 0, void 0, function* () {
                ...
                case 'ready':
                    ...
                    break;
                case 'room-invite':
                    puppet.on('room-invite', (payload) => __awaiter(this, void 0, void 0, function* () {
                        const roomInvitation = this.RoomInvitation.load(payload.roomInvitationId);
                        this.emit('room-invite', roomInvitation);
                    }));
                    break;
                case 'room-join':
                    puppet.on('room-join', (payload) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    break;
                case 'room-leave':
                    puppet.on('room-leave', (payload) => __awaiter(this, void 0, void 0, function* () {
                        const room = this.Room.load(payload.roomId);
                        /**
                        ...
                        if (selfId && payload.removeeIdList.includes(selfId)) {
                            yield this.puppet.roomPayloadDirty(payload.roomId);
                            yield this.puppet.roomMemberPayloadDirty(payload.roomId);
                        }
                    }));
                    break;
                case 'room-topic':
                    puppet.on('room-topic', (payload) => __awaiter(this, void 0, void 0, function* () {
                        const room = this.Room.load(payload.roomId);
                        yield room.sync();
                    ...
                    break;
                case 'scan':
                    puppet.on('scan', (payload) => __awaiter(this, void 0, void 0, function* () {
