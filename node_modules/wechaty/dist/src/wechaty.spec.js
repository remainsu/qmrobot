...
blue_tape_1.default('Export of the Framework', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
blue_tape_1.default('static VERSION', (t) => __awaiter(void 0, void 0, void 0, function* () {
    t.true('VERSION' in wechaty_1.Wechaty, 'Wechaty should has a static VERSION property');
}));
blue_tape_1.default('Config setting', (t) => __awaiter(void 0, void 0, void 0, function* () {
    t.ok(_1.config, 'should export Config');
    // t.ok(config.default.DEFAULT_PUPPET  , 'should has DEFAULT_PUPPET')
}));
blue_tape_1.default('event:start/stop', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
//   console.log(m)
// })
blue_tape_1.default('on(event, Function)', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
blue_tape_1.default('initPuppetAccessory()', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
blue_tape_1.default('Wechaty restart for many times', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
blue_tape_1.default('@event ready', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const puppet = new wechaty_puppet_mock_1.PuppetMock();
...
blue_tape_1.default('ready()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const puppet = new wechaty_puppet_mock_1.PuppetMock();
    const wechaty = new wechaty_1.Wechaty({ puppet });
    const sandbox = sinon_1.default.createSandbox();
    const spy = sandbox.spy();
