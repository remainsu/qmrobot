...
class Puppet extends events_1.EventEmitter {
    ...
    constructor(options = {}) {
        ...
        this.memory.load() // load here is for testing only
            .then(() => config_1.log.verbose('Puppet', 'constructor() memory.load() done'))
        ...
        this.watchdog.on('reset', lastFood => {
            config_1.log.warn('Puppet', 'constructor() watchdog.on(reset) reason: %s', JSON.stringify(lastFood));
        ...
        this.on('reset', payload => {
            config_1.log.silly('Puppet', 'constructor() this.on(reset) payload: "%s"', JSON.stringify(payload));
        ...
        this.cacheContactPayload = new quick_lru_1.default(lruOptions);
        this.cacheFriendshipPayload = new quick_lru_1.default(lruOptions);
        this.cacheMessagePayload = new quick_lru_1.default(lruOptions);
        this.cacheRoomPayload = new quick_lru_1.default(lruOptions);
        this.cacheRoomMemberPayload = new quick_lru_1.default(lruOptions);
        this.cacheRoomInvitationPayload = new quick_lru_1.default(lruOptions);
        /**
