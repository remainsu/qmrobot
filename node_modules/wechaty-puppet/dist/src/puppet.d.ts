...
import { EventDongPayload, EventErrorPayload, EventFriendshipPayload, EventLoginPayload, EventLogoutPayload, EventMessagePayload, EventResetPayload, EventRoomJoinPayload, EventRoomLeavePayload, EventRoomTopicPayload, EventRoomInvitePayload, EventScanPayload, EventReadyPayload, EventHeartbeatPayload } from './schemas/event';
 ...
 *
 */
export declare abstract class Puppet extends EventEmitter {
     ...
     * API After v0.21.6
     */
    emit(event: 'dong', payload: EventDongPayload): boolean;
    emit(event: 'error', payload: EventErrorPayload): boolean;
    emit(event: 'friendship', payload: EventFriendshipPayload): boolean;
    emit(event: 'login', payload: EventLoginPayload): boolean;
    emit(event: 'logout', payload: EventLogoutPayload): boolean;
    emit(event: 'message', payload: EventMessagePayload): boolean;
    emit(event: 'reset', payload: EventResetPayload): boolean;
    emit(event: 'room-invite', payload: EventRoomInvitePayload): boolean;
    emit(event: 'room-join', payload: EventRoomJoinPayload): boolean;
    emit(event: 'room-leave', payload: EventRoomLeavePayload): boolean;
    emit(event: 'room-topic', payload: EventRoomTopicPayload): boolean;
    emit(event: 'ready', payload: EventReadyPayload): boolean;
    emit(event: 'scan', payload: EventScanPayload): boolean;
    emit(event: 'heartbeat', payload: EventHeartbeatPayload): boolean;
     ...
     * API After v0.21.6
     */
    on(event: 'dong', listener: (payload: EventDongPayload) => void): this;
    on(event: 'error', listener: (payload: EventErrorPayload) => void): this;
    on(event: 'friendship', listener: (payload: EventFriendshipPayload) => void): this;
    on(event: 'login', listener: (payload: EventLoginPayload) => void): this;
    on(event: 'logout', listener: (payload: EventLogoutPayload) => void): this;
    on(event: 'message', listener: (payload: EventMessagePayload) => void): this;
    on(event: 'reset', listener: (payload: EventResetPayload) => void): this;
    on(event: 'room-join', listener: (payload: EventRoomJoinPayload) => void): this;
    on(event: 'room-leave', listener: (payload: EventRoomLeavePayload) => void): this;
    on(event: 'room-topic', listener: (payload: EventRoomTopicPayload) => void): this;
    on(event: 'room-invite', listener: (payload: EventRoomInvitePayload) => void): this;
    on(event: 'scan', listener: (payload: EventScanPayload) => void): this;
    on(event: 'ready', listener: (payload: EventReadyPayload) => void): this;
    on(event: 'heartbeat', listener: (payload: EventHeartbeatPayload) => void): this;
    ...
    contactPayloadDirty(contactId: string): Promise<void>;
    ...
    protected friendshipPayloadDirty(friendshipId: string): Promise<void>;
    /**
     * Get & Set
     */
    ...
    protected messagePayloadDirty(messageId: string): Promise<void>;
