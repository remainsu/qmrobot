...
export declare enum CheckQRCodeStatus {
    Ignore = -2,
    Unknown = -1,
    WaitScan = 0,
    WaitConfirm = 1,
...
export declare enum RoomAddTypeStatus {
    Done = 0,
    NeedInvite = -2012,
    InviteConfirm = -2028
}
 ...
 * 30 - 通过二维码方式
 */
export declare enum SearchContactTypeStatus {
    CONTACT = 17,
    EMAIL = 2,
    FLOAT = 25,
    MOBILE = 15,
...
export declare enum PadplusMessageStatus {
    One = 1
}
export declare enum PadplusStatus {
    One = 1
}
export declare enum PadplusContinue {
    Done = 0,
    Go = 1
}
export declare enum PadplusPayloadType {
    ExpirePadplusToken = -1113,
    InvalidPadplusToken = -1111,
    Logout = -1,
    OnlinePadplusToken = -1112
}
...
export declare enum PadplusEmojiType {
    Unknown = 0,
    Static = 1,
    Dynamic = 2
}
 ...
 */
export declare enum PadplusMessageType {
    Text = 1,
    Contact = 2,
    Image = 3,
    Deleted = 4,
...
export declare enum PadplusRoomMemberFlag {
    Zero = 0,
    One = 1,
    Eight = 8
}
export declare enum ContactOperationCmdId {
    Delete = 7,
    Operation = 2
}
export declare enum ContactOperationBitVal {
    SaveToContact = 2051,
    RemoveFromContact = 2,
    Star = 71,
    UnStar = 7,
...
export declare enum GrpcVoiceFormat {
    Amr = 1,
    Mp3 = 2,
    Wave = 3,
    Silk = 4
}
export declare enum GrpcA8KeyScene {
    ContactOrRoom = 2,
    HistoryReading = 3,
    QRCodeLink = 4,
    OAAccount = 7
}
export declare enum AutoLoginError {
    CALL_FAILED = "CALL_FAILED",
    LOGIN_ERROR = "LOGIN_ERROR"
}
export declare enum EncryptionServiceError {
    NO_SESSION = "NO_SESSION",
    INTERNAL_ERROR = "INTERNAL_ERROR"
}
export declare enum GrpcSelfAvatarType {
    CURRENT = 1,
    OLD = 2
}
export declare enum CDNFileType {
    IMAGE = 1,
    MID_IMAGE = 2,
    VIDEO_THUMBNAIL = 3,
    VIDEO = 4,
...
export declare enum CDNFileMd5Exist {
    NON_EXIST = 0,
    EXIST = 1
}
export declare enum PadplusErrorType {
    LOGIN = "LOGIN",
    NO_ID = "NO_ID",
    NO_CACHE = "NO_CACHE",
    EXIT = "EXIT"
}
export declare enum PadplusAutoLoginErrorType {
...
export declare enum MessageSendType {
    SELF_SENT = 1,
    CONTACT_SENT = 2
}
...
export declare enum GrpcMQType {
    RECEIVE_MESSAGE = 2,
...
//# sourceMappingURL=padplus-enums.d.ts.map