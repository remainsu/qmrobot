...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('events'), require('nop')) :
        typeof define === 'function' && define.amd ? define(['exports', 'events', 'nop'], factory) :
            (global = global || self, factory(global.window = {}, global.events, global.NOP));
}(this, (function (exports, events, NOP) {
    'use strict';
    NOP = NOP && Object.prototype.hasOwnProperty.call(NOP, 'default') ? NOP['default'] : NOP;
    /**
    ...
    var StateSwitch = /** @class */ (function (_super) {
         ...
         */
        StateSwitch.prototype.addEventListener = function (type, listener, options) {
            if (listener) {
                _super.prototype.addListener.call(this, type, listener);
            }
        };
        StateSwitch.prototype.removeEventListener = function (type, listener, options) {
            if (listener) {
                _super.prototype.removeListener.call(this, type, listener);
            }
        };
        return StateSwitch;
    }(events.EventEmitter));
