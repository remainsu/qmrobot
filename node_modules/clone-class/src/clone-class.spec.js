...
test('cloneClass smoke testing', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
test('cloneClass return NewClass with Original Name', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
test('throw error when lowercase static property initilized with defination', (t) => __awaiter(void 0, void 0, void 0, function* () {
    class Test {
    }
    Test.n = { mof: 42 };
    t.throws(() => clone_class_1.default(Test), 'should throw when the static property initialized with a object in defination');
}));
test('permit static property start with a captial letter to be initilized with defination', (t) => __awaiter(void 0, void 0, void 0, function* () {
    class Test {
    }
    Test.Data = { mof: 42 };
