...
export declare type FileBoxOptions = FileBoxOptionsCommon & (FileBoxOptionsBuffer | FileBoxOptionsFile | FileBoxOptionsStream | FileBoxOptionsUrl | FileBoxOptionsQRCode | FileBoxOptionsBase64);
...
export declare type FileBoxJsonObject = FileBoxJsonObjectCommon & (FileBoxJsonObjectBase64 | FileBoxJsonObjectUrl | FileBoxJsonObjectQRCode);
